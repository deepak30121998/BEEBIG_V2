...
var barChart, pieChart, lineChart, islinechart = document.getElementById("lineChart"),
    isbarchart = ((lineChartColor = getChartColorsArray("lineChart")) && (islinechart.setAttribute("width", islinechart.parentElement.offsetWidth), lineChart = new Chart(islinechart, {
        type: "line",
        data: {
    ...
    ispiechart = ((barChartColor = getChartColorsArray("bar")) && (isbarchart.setAttribute("width", isbarchart.parentElement.offsetWidth), barChart = new Chart(isbarchart, {
        type: "bar",
        data: {
            labels: ["January", "February", "March", "April", "May", "June", "July"],
            datasets: [{
                label: "Leads Analytics of 2023",
    ...
    isdoughnutchart = ((pieChartColors = getChartColorsArray("pieChart")) && (pieChart = new Chart(ispiechart, {
        type: "pie",
        data: {
    ...
    ispolarAreachart = ((doughnutChartColors = getChartColorsArray("doughnut")) && (lineChart = new Chart(isdoughnutchart, {
        type: "doughnut",
        data: {
            labels: ["Desktops", "Tablets"],
            datasets: [{
    ...
    isradarchart = ((polarAreaChartColors = getChartColorsArray("polarArea")) && (lineChart = new Chart(ispolarAreachart, {
        type: "polarArea",
        data: {
