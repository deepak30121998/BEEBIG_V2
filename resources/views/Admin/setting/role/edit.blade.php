                                    ...
                                    <form method="POST" action="{{ route('admin.roles.update',$role->id)}}">
                                        ...
                                        @method('put')
                                         <div class="form-check form-check-outline form-check-success mb-3">
                                             ...
                                             <input class="form-control" id="role_name" type="text" name="name" value="{{ old('name',$role->name) }}" placeholder="Enter role">
                                         ...
                                         <div class="form-check form-check-outline form-check-success mb-3">
                                             <input class="form-check-input" type="checkbox" name="permissions[]" value="{{$permission->id}}"  @if(count($role->permissions->where('id',$permission->id)))
                                             checked
                                           @endif>
