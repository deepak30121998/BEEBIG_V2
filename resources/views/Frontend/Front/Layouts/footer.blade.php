<div class="bg fixed bottom-28 rounded-full grid place-items-center opacity-0 invisible transition-all duration-300 right-[20px] z-[9999] w-[48px] h-[48px]" id="backToTop"><a class="rounded-full bg-green-900 grid place-items-center w-[48px] h-[48px]" href="#top"><img src="{{url('assets/images/icons/icon-up.svg')}}" alt="to top icon"></a></div>
	  ...
	  <footer class="mt-[92px] lg:mt-[150px] xl:mt-[200px] mb-[30px]">
        <div class="px-[12px] md:px-[36px] xl:px-0 mt-[70px]">
          ...
          <div class="flex flex-col items-center gap-2 mb-14 md:flex-row md:justify-between"> <img class="h-full w-full object-cover max-w-[162px]" src="{{url('assets/images007/logo.png')}}" alt="logo">
            <div class="flex items-center flex-col gap-5 md:flex-row lg:gap-[30px]">
              <p class="text-heading-6 font-chivo font-bold">Ready to get start a Project?</p>
              <button type="button"> <a class="flex items-center z-10 relative transition-all duration-200 group px-[22px] py-[15px] lg:px-[32px] lg:py-[22px] rounded-md bg-gray-900 text-white hover:bg-gray-100 hover:text-gray-900 w-fit" href="{{ route('front.contact') }}"><span class="block text-inherit w-full h-full rounded-md text-lg font-chivo font-semibold">Contact Us</span></a></button>
            </div>
          </div>
          ...
          <div class="text-gray-600 grid gird-cols-1 gap-8 mb-[48px] md:grid-cols-2 lg:grid-cols-5 xl:gap-[98px]">
            <div>
              ...
              <p class="text-text mb-5">BeeBig Digital is Delhi based customized process-driven website design & Development, Digital
                Marketing solutions provider based in India.</p>
              <p class="text-text underline"><a href="tel:+917678532363">(+91) 7678532363</a></p>
              </p>
            </div>
            <div>
